 ...
 */
public class CustomNestedScrollView extends FrameLayout implements NestedScrollingParent3,
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        View childViewGroup = getChildAt(0);
        int[] location = new int[2];
        if(childViewGroup instanceof LinearLayout){
            LinearLayout linearLayout = (LinearLayout) childViewGroup;
            linearLayout.getChildAt(0).getLocationInWindow(location);
        }
        int viewLocation = location[1];
        isScrollBottom = viewLocation <= Utils.dpToPx(160f);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        vtev.recycle();
        return limitViewHeight(ev) || super.onTouchEvent(ev);
    }
     ...
     * @return
     */
    private boolean limitViewHeight(MotionEvent ev) {
        if (getChildCount() != 0) {
            ...
            if (viewGroup instanceof LinearLayout) {
                ...
                if (linearLayout.getChildCount() >= 2) {
                    ...
                    if (view instanceof FrameLayout) {
                        ...
                        int vY = location[1];
                        int vTop = vY - (frameLayout.getHeight() / 2);
                        int vBottom = vY + (frameLayout.getHeight() / 2);

//                        LoggerUtils.INSTANCE.e("y:" + y + ";" + "vy:" + vY + ";" + "vTop:" + vTop + ";" + "vBottom:" + vBottom);
                        return y >= vTop && y <= vBottom;
                    }
                }
            }
        }
